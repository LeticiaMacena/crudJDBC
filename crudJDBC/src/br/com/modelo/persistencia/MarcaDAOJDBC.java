...
public class MarcaDAOJDBC implements MarcaDao {
    ...
    public void inserir(Marca m) {
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Erro em cadastrar uma marca:" + e.getMessage());
    ...
    public void atualizar(Marca m) {
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Erro em  atualzar uma marca:" + e.getMessage());
    ...
    public void excluir(int id) {
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Erro em excluir uma marca:" + e.getMessage());
